...
class Ligase_Type_QAPage {
    ...
    public function build(): ?array {
        ...
        if ( get_post_meta( $post_id, '_ligase_enable_qapage', true ) !== '1' && ! ( class_exists( 'Ligase_Schema_Rules' ) && Ligase_Schema_Rules::is_enabled_for_post( '_ligase_enable_qapage', $post_id ) ) ) {
            return null;
        }
